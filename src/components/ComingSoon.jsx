...
import arrowImg from "../assets/images/arrow-white.png";
import facebookIcon from "../assets/images/facebook.png";
import whatsappIcon from "../assets/images/whatsapp.png";
import instagramIcon from "../assets/images/insta.png";
import linkedinIcon from "../assets/images/linkedin.png";
import ScrollIcon from "../assets/images/scroll-icon-white.gif";
...
const ComingSoon = () => {
    ...
    return (
        <div className="main-container d-flex w-100 overflow-hidden container-fluid m-0 p-0 gap-0"
            style={{
            ...
            <AnimatePresence>
                {sidebarVisible && (
                    <motion.div
                        className="sidebar vh-100 d-flex flex-column text-white" id="sidebar"
                        ...
                        >
                                    ...
                                    <div key={service.id} className="mb-2">
                                        ...
                                        >
                                            ...
                                            <motion.div
                                                ...
                                                style={{
                                                    padding: openDropdown === service.id ? "1px 2px" : "0px",
                            ...
                            >
                                <div className="d-flex align-items-center mb-2 flex-column justify-content-between flex-wrap ">
                                    <p className="brochure-btn mb-1 text-decoration-none"
                                        style={{ fontSize: "20px" }}>
                                        <a href="tel:+919100579997" className="text-green futura-bold text-decoration-none">
                                            +91 91005 79997
                                        </a>
                                    </p>
                                    <p className="brochure-btn mb-1 text-decoration-none" style={{ fontSize: "20px" }}>
                                        <a href="tel:+919666265693" className="text-green futura-bold text-decoration-none">
                                            +91 96662 65693
                                        </a>
                                    </p>
                                </div>

                                <div className="w-100 mb-3" style={{ background: "white", height: "1px" }}>

                                </div>

                                <div className="d-flex align-items-center flex-column justify-content-between flex-wrap">

                                    <p className="brochure-btn mb-0 text-decoration-none futura-bold" style={{ fontSize: "14px" }}>
                                        <a href="mailto:adi@dezainally.com" className="text-green text-decoration-none">
                                            adi@dezainally.com
                                        </a>
                                    </p>
                                    <p className="brochure-btn mb-0 text-decoration-none futura-bold" style={{ fontSize: "14px" }}>
                                        <a href="mailto:infodw@dezainally.com" className="text-green text-decoration-none">
                                            infodw@dezainally.com
                                        </a>
                                    </p>
                                </div>
            ...
            >
                ...
                <motion.h6 className="futura-font first-line text-green"
                    initial={{ y: 260, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{
                        duration: 3,
                ...
                <motion.h1 className="fw-bolder second-line futura-font  text-green"
                    initial={{ y: 260, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{
                        duration: 3,
                        ease: [0.25, 0.1, 0.25, 1],
                        delay: 2.5, // 👈 comes after image
                    }}>
                    CREATIVITY{" "}
                    <span className="fw-normal"
                        initial={{ y: 260, opacity: 0 }}
                        ...
                        transition={{
                            duration: 3,
                            ease: [0.25, 0.1, 0.25, 1],
                            delay: 3, // 👈 comes after image
                        }}>
                        IS OUR CR<span className="fw-bolder futura-bold">AFT.</span>
                    </span>
                </motion.h1>

                <motion.h6 className="fw-medium third-line futura-regular  mb-1 text-green"
                    initial={{ y: 260, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{
                        duration: 3,
                        ease: [0.25, 0.1, 0.25, 1],
                        delay: 3.5, // 👈 comes after image
                    }}>
                    We’re shaping a new world of design and ideas.
                </motion.h6>

                <motion.h5 className="futura-regular fourth-line  text-green"
                    initial={{ y: 260, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{
                        duration: 3,
                        ease: [0.25, 0.1, 0.25, 1],
                        delay: 4, // 👈 comes after image
                    }}>
                    C O M I N G &nbsp; S O O N .
                </motion.h5>
            ...
            <AnimatePresence>
                {showPopup && (
                    ...
                    >
                        <motion.div
                            className="col-lg- position-relative"
